  ...
  return (
    <div className='w-screen h-screen flex flex-col items-center overflow-y-scroll no-scrollbar'>
      <div className='p-2 pr-3 pl-3 bg-gradient-to-r from-teal-100 to-teal-50 rounded-lg mt-12'>
        ...
        {/* form box */}
        <div className='bg-white w-[310px] md:w-[310px] mb-3 flex flex-col p-3 drop-shadow-lg border border-1 border-slate-400 rounded-lg mt-5'>
        ...
        <span className='text-sm font-mono text-slate-600 mt-4 md:mt-5'>Already have an account? <a href='/sign-in' className='text-blue-700 underline'>Sing In here</a></span>
        </div>
    </div>
  )
}
